...
# name of operations between each two nodes for NAS-SAM
SAM_PRIMITIVES = [
    'None',
    'Conv1',
    'Conv3',
...
# instance operations corresponds to SAM_PRIMITIVES
SAM_OPS = {
...
# name of operations between each two nodes for NAS-CAM
CAM_PRIMITIVES = [
    'None',
    'Conv1',
    'Conv3',
...
# instance operations corresponds to CAM_PRIMITIVES
CAM_OPS = {
